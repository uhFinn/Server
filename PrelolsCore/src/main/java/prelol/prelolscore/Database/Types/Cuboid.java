package prelol.prelolscore.Database.Types;
...
public class Cuboid {
    ...
    public Cuboid(Location loc1, Location loc2) {
        this(-1,loc1.getWorld(), loc1.getBlockX(), loc1.getBlockY(), loc1.getBlockZ(), loc2.getBlockX(), loc2.getBlockY(), loc2.getBlockZ());
    }

    public Cuboid(int id ,World world, int x1, int y1, int z1, int x2, int y2, int z2) {
